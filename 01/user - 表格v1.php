		  				        ...
		  				        <tr class="item-tr">
		  				          ...
		  				          <th class="item-thumb"  width="20">
										<div class="userpic" data-toggle="modal" data-remote="data/userinfo.html" data-target="#UserInfo">
											<a href="#"><img src="http://127.0.0.21/user_avatar/not.gif"></a>
		  				          ...
		  				          <td class="item-username">
		  				          		<div class="username text-info">
		  				          			...
		  				          			<span class="ftips">（付费剩余 22天）</span>
		  				          		</div>
		  				          		<div class="ftips">状态</div>
		  				          		<div class="userstatus text-green">正常</div>
		  				          		<div class="usergroup"><span data-toggle="tooltip" data-placement="right" title="" data-original-title="付费会员 剩余20天（2017-10-31 - 2017-10-31）"><i class="fa fa-diamond"></i></span>
		  				          		</div>

		  				          		<div class="action-group">
		  				          			<div class="btn-group dropup">
											      <button type="button" class="btn btn-danger btn-xs dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-trash-o"></i>删除
											      </button>
											      <ul class="dropdown-menu bg-danger do-action">
											        <li><a href="#">确认删除</a></li>
											      </ul>
											</div>
											<div class="btn-group dropup">
											      <button type="button" class="btn btn-warning btn-xs dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ban"></i>禁用
											      </button>
											      <ul class="dropdown-menu bg-warning do-action">
											        <li><a href="#">确认禁用</a></li>
											      </ul>
											</div>
		  				          			<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-remote="data/useredit.html" data-target="#UserInfo"><i class="fa fa-pencil"></i>编辑</button>
