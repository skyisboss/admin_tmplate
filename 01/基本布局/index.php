...
<div id="app">
	<div class="sidebar">
		...
		<ul class="header-menu-ul">
			...
			<li><a href="#"><i class="fa fa-fw fa-user"></i><span class="title">用户</span></a></li>
			<li><a href="#"><i class="fa fa-fw fa-th-large"></i><span class="title">分类</span></a></li>
		</ul>
	</div>
